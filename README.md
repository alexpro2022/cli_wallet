...
## Описание работы:
Данные хранятся в текстовом csv-файле, формат которого выбран разработчиком (требование ТЗ).
Управление осуществляется при помощи консольных команд, которые могут быть написаны в полном и сокращенном форматах. Также предусмотрен флаг -d (description - выводит в консоль описание команды - аналог флагов -h --help в продуктовых разработках)
<br>
